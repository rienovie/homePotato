...
def handle_instruction(instruction):
    ...
    if instruction.__contains__("cancel" or "stop"):
        print("Cancelling")
    elif instruction.__contains__("random voice" or "random value" or "voice to random"):
        ...
        voice.speak("It is currently " + datetime.datetime.now().strftime("%I:%M %p, on, %A, %B the %Do, %Y"))
    else:
